...
|------|-------|---------|--------|---------|-----------|----------|
| [Host](https://github.com./sharpninja/WindowsAppSdkHost) | ![GitHub Stars](https://img.shields.io/github/stars/sharpninja/WindowsAppSdkHost) ![Github Forks](	https://img.shields.io/github/forks/sharpninja/WindowsAppSdkHost) | | [![Packages](https://github.com/sharpninja/WindowsAppSdkHost/actions/workflows/packages.yml/badge.svg)](https://github.com/sharpninja/WindowsAppSdkHost/actions/workflows/packages.yml) | [![Dependent Repos](https://img.shields.io/librariesio/dependent-repos/nuget/SharpNinja.Extensions.WindowsAppSdkHost?logo=windows)](https://www.nuget.org/packages/SharpNinja.Extensions.WindowsAppSdkHost/)| | [Windows App SDK Desktop Host](https://github.com/CommunityToolkit/WindowsCommunityToolkit/discussions/4358) |
